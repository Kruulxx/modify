        ...
        return $form
            ->schema([
                ...
                ->afterStateUpdated(function (Closure $set, $get) {
                    // Check if the toggle is disabled, and update the state of the TextInput accordingly.
                    if (!$get('Q1')) {
                        $set('1st_quarter_grade_disabled', true);
                    } else {
                        $set('1st_quarter_grade_disabled', false);
                    }
                }),
